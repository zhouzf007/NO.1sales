...
import com.dianba.userdomain.constant.ThirdPlat;


public class OrderListVo implements Serializable{

	private static final long serialVersionUID = -3770152437456223293L;
	private Long id;
	...
	private BigDecimal needToPayMoney;
	/*关联商家信息*/
	...
	public String getFromTypeCn() {
		ThirdPlat plat = ThirdPlat.toThirdPlat(fromType);
		return null == plat ? fromType : plat.cn_name;
	}
	...
	public BigDecimal getNeedToPayMoney() {
		return needToPayMoney;
	}
	public void setNeedToPayMoney(BigDecimal needToPayMoney) {
		this.needToPayMoney = needToPayMoney;
	}
	...
	public void setMerchantMemberDiscountMoney(
			BigDecimal merchantMemberDiscountMoney) {
